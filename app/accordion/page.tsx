...
export default function Page() {
    return (
        <div className="w-full h-full p-4 pl-0 gap-4 flex items-center justify-center">
            <div className="flex-1 h-full">
                <Accordion.Root className="h-full">
                        ...
                        return (
                            <Accordion.Item key={index} id={index} thumbnail={`https://fluid-material.vercel.app/images/${index + 1}.webp`}>
                                ...
                                <div className="flex flex-col gap-6 py-3">
                                    ...
                                    <p className="text-base">Assumenda et cum officiis ea non ducimus dolorem voluptatum modi iste libero dignissimos nemo quis ipsam obcaecati, hic aliquid architecto! Reiciendis inventore quo assumenda aspernatur qui saepe hic molestias perferendis, facilis dolor voluptatem odit temporibus optio facere et, iste aut quae laboriosam at! Sunt voluptatem dicta, aspernatur nam natus quidem eaque accusamus tenetur. Libero, maxime totam. Fugiat tempore earum repellat mollitia suscipit esse.</p>
