...
export default function Home() {
  return (
    <div className="w-full flex flex-col gap-4 relative overflow-x-scroll hide-scrollbar md:pr-4 md:pt-4">
    <ShowcaseScroller />
    <div className="flex-auto">
      <div 
        className="overflow-x-scroll flex gap-3 pr-2 pl-1"
        style={{maskImage: 'linear-gradient(to right, transparent 0px, black 12px, black calc(100% - 18px), transparent 100%)'}}
        >
        <Chip 
          key={0} 
